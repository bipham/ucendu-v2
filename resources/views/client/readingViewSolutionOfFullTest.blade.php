...
@section('content')
    <div class="container solution-detail-page page-custom">
        ...
        @foreach($paragraphs as $key_paragraph => $paragraph)
            <div class="solution-detail panel-container transform-custom" data-order-paragraph="{!! $paragraph->order_paragraph !!}" data-paragraph-id="{!! $paragraph->id !!}">
                ...
                <div class="right-panel-custom panel-right panel-bottom active-quiz" id="solution-area" data-quizId="{!! $lesson_detail->id !!}">
