...
// Truyển message lên server Pusher
    ...
    Route::group(['prefix'=>'reading/{level_id}'],function () {
        ...
        Route::get('readingLesson/{type_lesson_id}/{lesson_id}',['as'=>'readingLesson','uses'=>'Client\ReadingLessonController@readingLessonDetail']);
        ...
        Route::get('readingViewLearning/{type_lesson_id}/{learning_id}',['as'=>'readingViewLearning','uses'=>'Client\ReadingLessonController@getReadingViewLearning']);
    });
